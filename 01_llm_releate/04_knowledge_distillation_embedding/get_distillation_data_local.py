...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, 
                        default="/opt/users/models/Qwen/Qwen3-Embedding-8B",
    ...
    parser.add_argument("--input_file", type=str, 
                        default="/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/data/processed_data_kd/processed_train_texts_negative_num_1.json",
                        help="Input JSON file path")
    parser.add_argument("--output_file", type=str, 
                        default="/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/data/train_data_kd/train_negative_num_1_8b.json",
