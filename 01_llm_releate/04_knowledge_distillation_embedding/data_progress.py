...
if __name__ == '__main__':
    process_data('/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/data/origin_data_kd', '/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/data/processed_data_kd', negative_num=3)