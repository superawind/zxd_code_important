...
class LLM(PreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, labels=None, cache_params = None):
        ...
        hidden_states = self.tokon_embeddings(input_ids)  # [bs, seq_len, hidden_size]
...
if __name__ == '__main__':
    ...
    args = TrainingArguments(output_dir='/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/qwen3_next/result_pretrain', 
                            num_train_epochs=1, 
                            do_train=True, 
    ...
    trainer.save_model('/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/qwen3_next/pretrain')
    trainer.save_state()
