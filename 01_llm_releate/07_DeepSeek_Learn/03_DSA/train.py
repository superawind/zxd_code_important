...
if __name__ == '__main__':
    ...
    model = Qwen2ForCausalLM.from_pretrained("/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/deepseek_dsa/step1_model", device_map='auto')
    ...
    tokenizer = AutoTokenizer.from_pretrained("/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/deepseek_dsa/step1_model")
    
    args = TrainingArguments(output_dir='/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/deepseek_dsa_step2', 
                            max_steps=2000, 
                            do_train=True, 
    ...
    dataset = SFTDataset('/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/data/sft_1024.jsonl', tokenizer=tokenizer, max_seq_len=2048)
    ...
    trainer.save_model('/mnt/code/zhaoxudong03/RL/verl_base_zxd/01_llm_releate/save_models/deepseek_dsa_step2/step2_model')
    trainer.save_state()
