    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if attention_mask is not None:
            ...
            # 增加掩码, 这是原生的 attn_weight 只有一个 自注意力掩码
            ...
            # 这是 增加了index 的掩码， 只计算前 k 个 token 的 attention 
...
if __name__ == '__main__':
    ...
    model = AutoModelForCausalLM.from_pretrained('/opt/users/models/Qwen2.5-0.5B-Instruct')
    ...
    model = Qwen2ForCausalLM.from_pretrained('/opt/users/models/Qwen2.5-0.5B-Instruct')
    output = model.generate(inputs, do_sample=False)
